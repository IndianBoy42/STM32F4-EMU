...
void cpu_aslzp(void);
void cpu_trbzp(void);
void cpu_orazpx(void);
void cpu_aslzpx(void);
void cpu_bitzp(void);
void cpu_andzp(void);
void cpu_rolzp(void);
void cpu_bitzpx(void);
void cpu_andzpx(void);
void cpu_rolzpx(void);
void cpu_eorzp(void);
void cpu_lsrzp(void);
void cpu_eorzpx(void);
void cpu_lsrzpx(void);
void cpu_stzzp(void);
void cpu_adczp(void);
void cpu_rorzp(void);
void cpu_stzzpx(void);
void cpu_adczpx(void);
void cpu_rorzpx(void);
void cpu_styzp(void);
void cpu_stazp(void);
void cpu_stxzp(void);
void cpu_styzpx(void);
void cpu_stazpx(void);
void cpu_stxzpy(void);
void cpu_ldyzp(void);
void cpu_ldazp(void);
void cpu_ldxzp(void);
void cpu_ldyzpx(void);
void cpu_ldazpx(void);
void cpu_ldxzpy(void);
void cpu_cpyzp(void);
void cpu_cmpzp(void);
void cpu_deczp(void);
void cpu_cmpzpx(void);
void cpu_deczpx(void);
void cpu_cpxzp(void);
void cpu_sbczp(void);
void cpu_inczp(void);
void cpu_sbczpx(void);
void cpu_inczpx(void);
void cpu_oraindzp(void);
void cpu_andindzp(void);
void cpu_eorindzp(void);
void cpu_adcindzp(void);
void cpu_staindzp(void);
void cpu_ldaindzp(void);
void cpu_cmpindzp(void);
void cpu_sbcindzp(void);
